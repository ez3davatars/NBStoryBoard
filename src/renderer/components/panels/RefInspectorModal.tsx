...
export const RefInspectorModal = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-8 bg-black/95 backdrop-blur-md">
            <div className="bg-[#09090b] border border-[#27272a] rounded-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex shadow-2xl animate-in zoom-in-95 duration-200">
                {/* Image Preview */}
