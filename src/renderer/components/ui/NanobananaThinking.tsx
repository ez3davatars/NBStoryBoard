...
export const NanobananaThinking = () => {
    return (
        <div className="fixed inset-0 z-[5000] flex items-center justify-center bg-black/60 backdrop-blur-xl animate-in fade-in duration-500 select-none">
            <div className="relative flex items-center justify-center scale-110">
                ...
                <div className="w-56 h-56 border-[3px] border-transparent border-t-yellow-500 border-b-yellow-500 rounded-full animate-spin shadow-[0_0_40px_rgba(234,179,8,0.3)]"></div>

                {/* Inner Reverse Spinner */}
                <div className="absolute w-44 h-44 border-[3px] border-transparent border-l-blue-500 border-r-blue-500 rounded-full animate-spin-reverse shadow-[0_0_30px_rgba(59,130,246,0.3)]"></div>

                {/* Central Core (Banana) */}
                <div className="absolute flex flex-col items-center">
                    <div className="text-[72px] animate-bounce-slow drop-shadow-[0_0_20px_rgba(234,179,8,0.8)] filter brightness-110 grayscale-0">
                        🍌
                    </div>
                </div>
                ...
                <div className="absolute -bottom-32 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 w-full text-center min-w-[300px]">
                    <div className="flex items-center justify-center gap-3 w-full">
                        ...
                        <p className="text-yellow-500 font-black tracking-[0.4em] uppercase text-[12px] animate-pulse whitespace-nowrap drop-shadow-lg">
