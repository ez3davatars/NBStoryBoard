    ...
    <div className="flex flex-col h-full text-gray-200">
        ...
        <InspectorSection title="Temporal Director" defaultOpen={true}>
          <div className="flex bg-black/40 p-1 rounded-lg border border-white/5 mx-auto mb-2 w-full justify-center">
            <button
              ...
              className={`flex-1 py-1 rounded text-[9px] font-bold uppercase transition-all ${activeSlot === 1 ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-600 hover:text-gray-400'}`}
            >Start Plate</button>
            <button
              onClick={() => setActiveSlot(2)}
              className={`flex-1 py-1 rounded text-[9px] font-bold uppercase transition-all ${activeSlot === 2 ? 'bg-indigo-600 text-white shadow-lg' : 'text-gray-600 hover:text-gray-400'}`}
            >End Plate</button>
          </div>
      ...
      <div className="shrink-0 p-4 border-t border-white/10 bg-black/40 backdrop-blur-md flex flex-col gap-2">
        <button
          ...
          className="w-full py-2.5 rounded-full flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest transition-all bg-gradient-to-r from-yellow-400 to-amber-500 text-black hover:scale-[1.02] shadow-[0_0_15px_rgba(250,204,21,0.3)] disabled:opacity-50 disabled:scale-100"
        >
