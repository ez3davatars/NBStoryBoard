...
const NanoCastingDirector = () => {
    ...
    const styleMatrix = {
        ...
        hyper_real: {
            ...
            keywords: "Photorealistic 8k, raw photo, highly detailed skin pores, 85mm lens, f/1.8, cinematic natural lighting, sharp focus, masterpiece.",
        ...
        exact_studio: {
            ...
            keywords: "Ultra-realistic 8k portrait, exact facial likeness preservation, studio lighting, highly detailed skin texture, raw photography, 85mm lens, sharp focus, masterpiece.",
                    ...
                    {[1, 2, 3, 4, 5].map((p) => {
                        ...
                        return (
                            <button 
                                ...
                                title={reason || ""}
                                className={`w-full text-left px-4 py-4 rounded-xl border transition-all group relative overflow-hidden flex justify-between items-center ${
                                    phase === p 
                                    ...
                                    <div className="flex justify-between items-center mb-6">
                                        <div className="flex bg-surface-2 rounded-lg p-1 gap-1">
                                             <button 
                                                ...
                                                className={`px-3 py-1.5 rounded-md text-[10px] uppercase font-black tracking-wider transition-all border ${
                                                ...
                                                <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] z-30 flex items-center justify-center transition-all duration-300 pointer-events-none ${isScanning ? 'scale-105' : 'scale-100'}`}>
                                                    ...
                                                    <div 
                                                        className={`w-2 h-2 rounded-full transition-all ${
                                                            isScanning ? 'bg-success scale-150 shadow-[0_0_15px_#22c55e]' : 'bg-accent/50'
                                                        }`}
                                                    ></div>
                                                </div>
                                     ...
                                     <div className="mt-auto">
                                        ...
                                        >
                                         ...
                                         <button 
                                            ...
                                            onClick={() => setPhase(2)}
                                            className={`w-full py-4 font-black uppercase tracking-widest transition-all text-xs rounded-lg flex items-center justify-center gap-2 ${
                                                isPhaseLocked(2) 
                            ...
                            >
                                    ...
                                    {bodyArchetypes.map((type) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`relative group h-96 border rounded-2xl p-6 flex flex-col items-center justify-between transition-all duration-300 overflow-hidden ${
                                ...
                                <div className="mt-16 flex justify-between w-full max-w-6xl">
                                    ...
                                    <button 
                                        ...
                                        onClick={() => setPhase(3)}
                                        className={`px-12 py-4 text-sm font-black uppercase tracking-widest rounded-lg transition-all ${
                                            selectedBody
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
                                    {Object.values(styleMatrix).map((style) => (
                                        <button
                                            ...
                                            className={`group relative h-40 border rounded-xl transition-all duration-300 overflow-hidden flex flex-col justify-center px-8 ${
