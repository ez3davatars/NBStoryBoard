            ...
            {isOpen && (
                <div className="fixed inset-0 z-[3000] bg-black/80 backdrop-blur-sm flex items-center justify-center p-8 animate-in fade-in duration-200">
                    <motion.div
                        ...
                        className="bg-[#0f0f11] border border-white/10 p-8 rounded-3xl shadow-2xl max-w-xl w-full relative overflow-hidden flex flex-col max-h-[90vh]"
                    >
                        {/* HEADER */}
                        <div className="mb-6">
                            ...
                            {STUDIOS.map((studio) => (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 h-full flex flex-col justify-center px-8 w-2/3">
                                        <h4 className="text-2xl font-black italic text-white uppercase tracking-tighter leading-none mb-1 drop-shadow-lg">
                                            {studio.label}
                                        </h4>
