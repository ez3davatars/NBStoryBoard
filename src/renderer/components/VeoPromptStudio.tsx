...
export default function VeoPromptStudio() {
 ...
 const sbPill =
 "inline-flex items-center h-10 rounded-xl border border-[#2a303a] bg-[#0f141b] p-1 gap-1";
 ...
 const sbBtnActive =
 "bg-[#1a212b] text-white border border-[#3a4250] ";
 ...
 Storyboard Studio
 <span className="text-[9px] font-black uppercase tracking-wider text-black bg-yellow-500 px-1.5 py-0.5 rounded-sm -[0_0_10px_rgba(234,179,8,0.5)]">Experimental</span>
 </h2>
 </div>
 ...
 {/* --- Content Panes --- */}
 {/* Left Rail */}
 <div className="col-start-1 row-start-1 backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl ring-1 ring-white/5 flex flex-col min-h-0 overflow-hidden">
 <StoryboardShotRail />
 </div>
 ...
 {/* Right Inspector */}
 <div className="col-start-5 row-start-1 backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl ring-1 ring-white/5 flex flex-col min-h-0 overflow-hidden">
 <div className="flex-1 overflow-y-auto relative min-h-0 bg-black/20">
 ...
 <div className="col-start-1 col-span-5 row-start-3 backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl ring-1 ring-white/5 flex flex-col min-h-0 overflow-hidden">
 ...
 >
 <div className="absolute inset-y-2 left-1/2 -translate-x-1/2 w-px bg-white/10 group-hover:bg-white/20 transition-colors group-hover:-[0_0_20px_rgba(250,204,21,0.12)]" />
 ...
 >
 <div className="absolute inset-x-2 top-1/2 -translate-y-1/2 h-px bg-white/10 group-hover:bg-white/20 transition-colors group-hover:-[0_0_20px_rgba(250,204,21,0.12)]" />
