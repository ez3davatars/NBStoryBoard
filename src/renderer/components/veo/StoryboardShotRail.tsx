...
import { Search, Film, Image as ImageIcon, Plus } from 'lucide-react';
...
export default function StoryboardShotRail() {
 ...
 ${isActive
 ? 'bg-yellow-500/10 border-yellow-500/30 -[0_0_15px_rgba(234,179,8,0.1)] ring-1 ring-yellow-500/20'
