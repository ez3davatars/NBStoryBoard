...
export default function StoryboardShotRail() {
  ...
  return (
    <div className="flex flex-col h-full bg-black/20">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1 rounded bg-white/5 hover:bg-red-500/20 text-gray-400 hover:text-red-500 transition-colors"
      ...
      {/* Shots List */}
      <div className="flex-1 h-full min-h-0 overflow-y-auto p-4 pb-6 space-y-2">
        {filteredShots.map((shot, index) => {
          ...
          return (
            <div
              ...
              className={`w-full group flex items-center gap-3 p-2 rounded-xl border transition-all text-left cursor-pointer
                ${isActive
            ...
            >
              ...
              <button
                ...
                className="p-1.5 shrink-0 text-gray-500 hover:text-red-500 hover:bg-red-500/10 rounded-md opacity-0 group-hover:opacity-100 transition-all border border-transparent hover:border-red-500/20 flex items-center justify-center"
                title="Delete Shot"
              >
      ...
      <ConfirmDialog
        ...
        title="Clear All Shots"
        message="Are you sure you want to delete all saved shots? This cannot be undone."
      ...
      <ConfirmDialog
        ...
        title="Delete Shot"
        message={`Are you sure you want to delete "${shotToDelete?.name || 'this shot'}"? All associated timelines and actions will be permanently deleted. This cannot be undone.`}
        confirmText="Delete"
        variant="danger"
      />
    </div>
