...
export default function VeoBottomDock({ mode }: VeoBottomDockProps) {
    ...
    const formattedPrompt = useMemo(() => {
        ...
        return formatVeoFivePartPrompt({
    ...
    return (
        <div className="h-full w-full backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-xl ring-1 ring-white/5 flex flex-col min-h-0 overflow-hidden relative group">
            ...
            <div className="h-full min-h-0 overflow-y-auto p-4 pb-6 flex flex-col">
                ...
                <div className="flex-1 overflow-hidden relative min-h-[60px]">
                    <textarea
                        ...
                        className="w-full h-full bg-black/40 border border-white/5 rounded-lg p-4 text-xs font-mono text-emerald-300/90 leading-relaxed outline-none resize-none no-scrollbar shadow-inner"
                    />
                </div>
