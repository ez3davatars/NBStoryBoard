...
export default function VeoTimelinePanel() {
 ...
 <div className="flex items-center bg-[#09090b] border border-[#27272a] rounded overflow-hidden ">
 <input
 type="text"
 ...
 className="w-full bg-[#09090b] text-gray-300 text-[13px] leading-relaxed resize-y border border-transparent focus:border-white/10 p-3 outline-none transition-all placeholder:text-zinc-600 rounded-lg min-h-[44px]"
 minRows={2}
 maxRows={10}
 />
 </div>
 ...
 <button
 onClick={handleAddBeat}
 className="bg-[#18181b] hover:bg-[#27272a] border border-[#27272a] border-dashed text-zinc-400 hover:text-white w-full py-3 rounded-xl uppercase text-xs font-bold transition-all flex justify-center items-center gap-2 "
 >
