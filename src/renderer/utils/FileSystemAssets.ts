...
const hasPermissionMethods = (handle: FileSystemHandle): handle is PermissionCapableHandle =>
    typeof (handle as PermissionCapableHandle).queryPermission === 'function'
    && typeof (handle as PermissionCapableHandle).requestPermission === 'function';
...
export const verifyPermission = async (
    ...
    if (!hasPermissionMethods(fileHandle)) {
